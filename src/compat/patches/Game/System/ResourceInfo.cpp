// =============================================================================
// PC_PORT PATCH of the vendored Game/System/ResourceInfo.cpp (M9.5.3a).
//
// Changes vs. upstream: <size_t.h> (MSL_C, not on the host include path)
// becomes <cstddef>, and the Game/Util.hpp umbrella include (drags in J3D
// headers the host GX types collide with) becomes the HashUtil.hpp that
// actually declares MR::getHashCodeLower. ResTable/ResFileInfo bodies are
// verbatim.
// =============================================================================
#include "Game/System/ResourceInfo.hpp"
#include "Game/Util/HashUtil.hpp"  // PC_PORT: was Game/Util.hpp (umbrella drags in J3DFifo)
#include <cstdio>
#include <cstring>
#include <cstddef>
