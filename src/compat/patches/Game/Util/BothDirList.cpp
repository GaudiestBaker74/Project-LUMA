...
// PC_PORT PATCH (compat/patches): upstream includes the "Game/Util.hpp"
// umbrella header (all of Game/Util), which pulls trees that are not
// host-compiled. Only BothDirList.hpp is needed here.
