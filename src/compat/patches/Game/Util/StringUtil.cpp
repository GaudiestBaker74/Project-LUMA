// =============================================================================
// PC_PORT PATCH of the vendored Game/Util/StringUtil.cpp (see
// patches/README.md).
//
// Change: #include <cstring> — the MWC sources get strncpy/strrchr/... from
// Metrowerks' string.h implicitly; on the host they are only visible with the
// explicit <cstring>.
// =============================================================================
#include <cstring>
