...
//
// Change vs. upstream: the GX FIFO write helpers access the PPC write-gather
// pipe union members, which are renamed `_u8/_u16/_s16/_u32/_f32` on host
// toolchains (see PPCWGPipe.h). The helpers themselves are only used by the
// decompiled GX implementation, which is replaced by compat/gx.
// ============================================================================
...
#define GX_WRITE_U8(ub) gxfifo._u8 = (u8)(ub)

#define GX_WRITE_U16(us) gxfifo._u16 = (u16)(us)

#define GX_WRITE_S16(us) gxfifo._s16 = (u16)(us)

#define GX_WRITE_U32(ui) gxfifo._u32 = (u32)(ui)

#define GX_WRITE_F32(f) gxfifo._f32 = (f32)(f);
