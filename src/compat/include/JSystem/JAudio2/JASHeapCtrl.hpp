// =============================================================================
// PC_PORT PATCH — override of the vendored JSystem/JAudio2/JASHeapCtrl.hpp
// (this directory is FIRST in the include path; see compat/include/README.md).
//
// Changes (byte-for-byte identical otherwise):
//   * JASPoolAllocObject / JASPoolAllocObject_MultiThreaded: `operator new(u32)`
//     and `operator delete(void*, u32)` take size_t on a host toolchain
//     (Metrowerks allowed u32).
// =============================================================================
#pragma once
