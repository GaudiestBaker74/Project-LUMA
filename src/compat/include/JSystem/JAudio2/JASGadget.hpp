// =============================================================================
// PC_PORT PATCH — override of the vendored JSystem/JAudio2/JASGadget.hpp
// (this directory is FIRST in the include path; see compat/include/README.md).
//
// One change, byte-for-byte identical otherwise:
//   * JASPtrArray's member-init list spells the base as `JASPtrTable< T >`
//     (the Metrowerks compiler accepted the unqualified `JASPtrTable(...)`
//     base specifier; GCC/Clang/MSVC reject it).
// =============================================================================
#pragma once
...
public:
    JASPtrArray() : JASPtrTable< T >(mPtrArray, LEN) {  // PC_PORT: base spec
    }
